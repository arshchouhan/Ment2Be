    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-md border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/" state={{ fromNavbar: true }} className="flex items-center space-x-2">
            <img 
              src={logoHat} 
              alt="Ment2Be Logo" 
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-80 bg-[#1a1a1a] border border-gray-700 rounded-lg shadow-xl p-4 space-y-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                {/* Personal Dashboard */}
                <button onClick={() => scrollToSection('dashboard-section')} className="w-full flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-800/50 transition-colors group text-left">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-semibold text-sm">Personal Dashboard</h4>
                    <p className="text-gray-400 text-xs mt-1">Track your progress and manage your learning journey</p>
                  </div>
                </button>
                
                {/* Connect with Mentors */}
                <button onClick={() => scrollToSection('connect-mentors-section')} className="w-full flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-800/50 transition-colors group text-left">
                  <div className="flex-shrink-0 mt-1">
                    <svg className="w-5 h-5 text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-semibold text-sm">Connect with Mentors</h4>
                    <p className="text-gray-400 text-xs mt-1">Build meaningful connections with expert mentors</p>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-64 bg-[#1a1a1a] border border-gray-700 rounded-lg shadow-xl p-4 space-y-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                {/* For Students */}
                <Link to="/solutions" state={{ fromNavbar: true }} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-800/50 transition-colors group">
                  <div className="flex-shrink-0 mt-1">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-semibold text-sm">For Students</h4>
                    <p className="text-gray-400 text-xs mt-1">Get personalized guidance and track progress</p>
                  </div>
                </Link>
                ...
                <Link to="/solutions" state={{ fromNavbar: true }} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-800/50 transition-colors group">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-semibold text-sm">For Mentors</h4>
                    <p className="text-gray-400 text-xs mt-1">Share expertise and manage mentees</p>
                  </div>
                </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              to="/register"
              className="px-5 py-2 bg-white text-black font-medium rounded-lg hover:bg-gray-100 transition-colors text-sm flex items-center space-x-2"
            >

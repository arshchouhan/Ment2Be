  ...
  return (
    <div className="min-h-screen bg-[#202327]">
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              <div className="bg-[#121212] border border-[#404040] rounded-lg px-4 py-2">
        ...
        {error ? (
          <div className="bg-[#121212] border border-red-500 rounded-xl p-6">
          ...
          <div className="bg-[#121212] border border-[#404040] rounded-xl p-12 text-center">
            <div className="bg-[#202327] w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-[#121212] border border-[#404040] rounded-lg px-3 py-2">
              ...
              <div className="grid grid-cols-12 gap-8">
                ...
                <div className="col-span-12 lg:col-span-4 space-y-6">
                  ...
                  <div className="bg-[#121212] border border-[#404040] rounded-xl p-6">

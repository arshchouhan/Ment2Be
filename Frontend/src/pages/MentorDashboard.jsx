          ...
          {!editing && (
            <div className="bg-[#121212] rounded-xl shadow-lg p-6 border border-gray-700">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold flex items-center" style={{color: '#ffffff'}}>
        ...
        <aside className="col-span-1 md:col-span-1 lg:col-span-3 space-y-3">
          ...
          <div className="bg-[#121212] rounded-xl shadow-lg p-4 border border-gray-700">
            ...
            <button 
              ...
              <FiUsers className="w-4 h-4 mr-2 text-indigo-400" />
          ...
          <div className="bg-[#121212] rounded-xl shadow-lg p-3 border border-gray-700">
            ...
            {sessionsLoading ? (
              <div className="text-gray-800 text-center py-4">
                <FiClock className="w-6 h-6 mx-auto mb-2 animate-spin text-orange-400" />
                Loading sessions...
              </div>
              ...
              <div className="text-center py-8">
                <FiUsers className="w-12 h-12 text-indigo-400 mx-auto mb-4" />
